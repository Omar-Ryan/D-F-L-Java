...
public class LearnJava {
    ...
    public static void main(String[] args) {
        ...
        try (Scanner inputTicket = new Scanner(System.in)) {
            int weightBag, priceOfIncWeight = 0, numOfPassengers, totalIncWeight, totalPrice = 0;
            ...
            System.out.println("the total increment weight A1 = " + totalIncWeight + " KG");
            System.out.println("the total price of all increment weight A1 = " + totalPrice + " $");
        }
    }
}